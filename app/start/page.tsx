      ...
      <div className="w-full max-w-[560px]">
        ...
        {step === "email" && p && (
          <>
            ...
            <div
              className="bg-[#111113] px-7 pt-7 pb-6 mb-8"
              style={{ border: "1px solid #1e1e22" }}
            >
              <p style={mono} className="font-bold text-[10px] tracking-[0.25em] uppercase text-[#C4813A] mb-4 pb-4" >
                Five days. One honest look each day.
              </p>
              <div className="w-full h-px bg-[#1e1e22] -mt-4 mb-4" />
        ...
        {step === "done" && (
          <>
            ...
            <div className="py-6" style={{ borderTop: "1px solid #1e1e22" }}>
              <p className="text-base text-[#f0ede8] font-light leading-[1.75] mt-6">
